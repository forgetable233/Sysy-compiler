...
define i32 @add(i32* %a0, i32* %a1, i32* %a2, i32* %b0, i32* %b1, i32* %b2, i32* %c0, i32* %c1, i32* %c2) {
begin:
  %0 = alloca i32*
  %1 = alloca i32*
  %2 = alloca i32*
...
loop_body:                                        ; preds = %loop_header
  ...
  %add = fadd i32 %15, %19
  %20 = load i32, i32* %i
  %21 = getelementptr i32, i32* %11, i32 %20
  store volatile i32 %add, i32* %21
  %22 = load i32*, i32** %7
  %23 = load i32*, i32** %1
  %24 = load i32, i32* %i
  ...
  %add1 = fadd i32 %26, %30
  %31 = load i32, i32* %i
  %32 = getelementptr i32, i32* %22, i32 %31
  store volatile i32 %add1, i32* %32
  %33 = load i32*, i32** %8
  %34 = load i32*, i32** %2
  %35 = load i32, i32* %i
  ...
  %add2 = fadd i32 %37, %41
  %42 = load i32, i32* %i
  %43 = getelementptr i32, i32* %33, i32 %42
  store volatile i32 %add2, i32* %43
  %44 = load i32, i32* %i
  %add3 = fadd i32 %44, 1
...
loop_exit:                                        ; preds = %loop_header1, %loop_header
  ...
  %call = call i32 @add(i32* %2, i32* %3, i32* %4, i32* %5, i32* %6, i32* %7, i32* %8, i32* %9, i32* %10)
