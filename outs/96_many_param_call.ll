...
begin:
  ...
  %sub = fsub i32 %add, %10
  %11 = load i32, i32* %3
  %sub1 = fsub i32 %sub, %11
  %12 = load i32, i32* %4
  %sub2 = fsub i32 %sub1, %12
  %13 = load i32, i32* %5
  %add3 = fadd i32 %sub2, %13
  %14 = load i32, i32* %6
  %add4 = fadd i32 %add3, %14
  %15 = load i32, i32* %7
  %add5 = fadd i32 %add4, %15
  ret i32 %add5
}
...
begin:
  ...
  %19 = load i32, i32* %3
  %add2 = fadd i32 %add1, %19
  %20 = load i32, i32* %4
  %add3 = fadd i32 %add2, %20
  %21 = load i32, i32* %5
  %add4 = fadd i32 %add3, %21
  %22 = load i32, i32* %6
  %add5 = fadd i32 %add4, %22
  %23 = load i32, i32* %7
  %add6 = fadd i32 %add5, %23
  %24 = load i32, i32* %8
  %sub = fsub i32 %add6, %24
  %25 = load i32, i32* %9
  %add7 = fadd i32 %sub, %25
  %26 = load i32, i32* %10
...
begin:
  ...
  %44 = load i32, i32* %12
  %sub = fsub i32 %add10, %44
  %45 = load i32, i32* %13
  %sub11 = fsub i32 %sub, %45
  %46 = load i32, i32* %14
  %sub12 = fsub i32 %sub11, %46
  %47 = load i32, i32* %15
  %sub13 = fsub i32 %sub12, %47
  %48 = load i32, i32* %16
  %sub14 = fsub i32 %sub13, %48
  %49 = load i32, i32* %17
  %sub15 = fsub i32 %sub14, %49
  %50 = load i32, i32* %18
  %sub16 = fsub i32 %sub15, %50
  %51 = load i32, i32* %19
  %sub17 = fsub i32 %sub16, %51
  %52 = load i32, i32* %20
  %sub18 = fsub i32 %sub17, %52
  %53 = load i32, i32* %21
  %sub19 = fsub i32 %sub18, %53
  %54 = load i32, i32* %22
  %add20 = fadd i32 %sub19, %54
  %55 = load i32, i32* %23
  %add21 = fadd i32 %add20, %55
  %56 = load i32, i32* %24
