...
6:                                                ; preds = %2
  ...
  %32 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %7, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.5, i64 0, i64 0), i32 %11, i32 %15, i32 %19, i32 %23, i32 %27, i32 %31)
...
66:                                               ; preds = %2
  ...
  %72 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %67, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.6, i64 0, i64 0), i32 %68, i32 %69, i32 %70, i32 %71)
  ret void
}
...
define dso_local void @_sysy_starttime(i32 %0) #0 {
  ...
  %7 = call i32 @gettimeofday(%struct.timeval* @_sysy_start, i8* null) #3
  ret void
}
...
define dso_local void @_sysy_stoptime(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = call i32 @gettimeofday(%struct.timeval* @_sysy_end, i8* null) #3
